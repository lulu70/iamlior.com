...
export type FileFieldsEnum =
  ...
  | 'childrenMdx___frontmatter___screenshot___absolutePath'
  | 'childrenMdx___frontmatter___screenshot___relativePath'
  | 'childrenMdx___frontmatter___screenshot___extension'
  | 'childrenMdx___frontmatter___screenshot___size'
  | 'childrenMdx___frontmatter___screenshot___prettySize'
  | 'childrenMdx___frontmatter___screenshot___modifiedTime'
  | 'childrenMdx___frontmatter___screenshot___accessTime'
  | 'childrenMdx___frontmatter___screenshot___changeTime'
  | 'childrenMdx___frontmatter___screenshot___birthTime'
  | 'childrenMdx___frontmatter___screenshot___root'
  | 'childrenMdx___frontmatter___screenshot___dir'
  | 'childrenMdx___frontmatter___screenshot___base'
  | 'childrenMdx___frontmatter___screenshot___ext'
  | 'childrenMdx___frontmatter___screenshot___name'
  | 'childrenMdx___frontmatter___screenshot___relativeDirectory'
  | 'childrenMdx___frontmatter___screenshot___dev'
  | 'childrenMdx___frontmatter___screenshot___mode'
  | 'childrenMdx___frontmatter___screenshot___nlink'
  | 'childrenMdx___frontmatter___screenshot___uid'
  | 'childrenMdx___frontmatter___screenshot___gid'
  | 'childrenMdx___frontmatter___screenshot___rdev'
  | 'childrenMdx___frontmatter___screenshot___ino'
  | 'childrenMdx___frontmatter___screenshot___atimeMs'
  | 'childrenMdx___frontmatter___screenshot___mtimeMs'
  | 'childrenMdx___frontmatter___screenshot___ctimeMs'
  | 'childrenMdx___frontmatter___screenshot___atime'
  | 'childrenMdx___frontmatter___screenshot___mtime'
  | 'childrenMdx___frontmatter___screenshot___ctime'
  | 'childrenMdx___frontmatter___screenshot___birthtime'
  | 'childrenMdx___frontmatter___screenshot___birthtimeMs'
  | 'childrenMdx___frontmatter___screenshot___blksize'
  | 'childrenMdx___frontmatter___screenshot___blocks'
  | 'childrenMdx___frontmatter___screenshot___publicURL'
  | 'childrenMdx___frontmatter___screenshot___childrenImageSharp'
  | 'childrenMdx___frontmatter___screenshot___childrenMdx'
  | 'childrenMdx___frontmatter___screenshot___id'
  | 'childrenMdx___frontmatter___screenshot___children'
  | 'childrenMdx___frontmatter___external'
  ...
  | 'childMdx___frontmatter___screenshot___absolutePath'
  | 'childMdx___frontmatter___screenshot___relativePath'
  | 'childMdx___frontmatter___screenshot___extension'
  | 'childMdx___frontmatter___screenshot___size'
  | 'childMdx___frontmatter___screenshot___prettySize'
  | 'childMdx___frontmatter___screenshot___modifiedTime'
  | 'childMdx___frontmatter___screenshot___accessTime'
  | 'childMdx___frontmatter___screenshot___changeTime'
  | 'childMdx___frontmatter___screenshot___birthTime'
  | 'childMdx___frontmatter___screenshot___root'
  | 'childMdx___frontmatter___screenshot___dir'
  | 'childMdx___frontmatter___screenshot___base'
  | 'childMdx___frontmatter___screenshot___ext'
  | 'childMdx___frontmatter___screenshot___name'
  | 'childMdx___frontmatter___screenshot___relativeDirectory'
  | 'childMdx___frontmatter___screenshot___dev'
  | 'childMdx___frontmatter___screenshot___mode'
  | 'childMdx___frontmatter___screenshot___nlink'
  | 'childMdx___frontmatter___screenshot___uid'
  | 'childMdx___frontmatter___screenshot___gid'
  | 'childMdx___frontmatter___screenshot___rdev'
  | 'childMdx___frontmatter___screenshot___ino'
  | 'childMdx___frontmatter___screenshot___atimeMs'
  | 'childMdx___frontmatter___screenshot___mtimeMs'
  | 'childMdx___frontmatter___screenshot___ctimeMs'
  | 'childMdx___frontmatter___screenshot___atime'
  | 'childMdx___frontmatter___screenshot___mtime'
  | 'childMdx___frontmatter___screenshot___ctime'
  | 'childMdx___frontmatter___screenshot___birthtime'
  | 'childMdx___frontmatter___screenshot___birthtimeMs'
  | 'childMdx___frontmatter___screenshot___blksize'
  | 'childMdx___frontmatter___screenshot___blocks'
  | 'childMdx___frontmatter___screenshot___publicURL'
  | 'childMdx___frontmatter___screenshot___childrenImageSharp'
  | 'childMdx___frontmatter___screenshot___childrenMdx'
  | 'childMdx___frontmatter___screenshot___id'
  | 'childMdx___frontmatter___screenshot___children'
  | 'childMdx___frontmatter___external'
...
export type MdxFieldsEnum =
  ...
  | 'frontmatter___screenshot___absolutePath'
  | 'frontmatter___screenshot___relativePath'
  | 'frontmatter___screenshot___extension'
  | 'frontmatter___screenshot___size'
  | 'frontmatter___screenshot___prettySize'
  | 'frontmatter___screenshot___modifiedTime'
  | 'frontmatter___screenshot___accessTime'
  | 'frontmatter___screenshot___changeTime'
  | 'frontmatter___screenshot___birthTime'
  | 'frontmatter___screenshot___root'
  | 'frontmatter___screenshot___dir'
  | 'frontmatter___screenshot___base'
  | 'frontmatter___screenshot___ext'
  | 'frontmatter___screenshot___name'
  | 'frontmatter___screenshot___relativeDirectory'
  | 'frontmatter___screenshot___dev'
  | 'frontmatter___screenshot___mode'
  | 'frontmatter___screenshot___nlink'
  | 'frontmatter___screenshot___uid'
  | 'frontmatter___screenshot___gid'
  | 'frontmatter___screenshot___rdev'
  | 'frontmatter___screenshot___ino'
  | 'frontmatter___screenshot___atimeMs'
  | 'frontmatter___screenshot___mtimeMs'
  | 'frontmatter___screenshot___ctimeMs'
  | 'frontmatter___screenshot___atime'
  | 'frontmatter___screenshot___mtime'
  | 'frontmatter___screenshot___ctime'
  | 'frontmatter___screenshot___birthtime'
  | 'frontmatter___screenshot___birthtimeMs'
  | 'frontmatter___screenshot___blksize'
  | 'frontmatter___screenshot___blocks'
  | 'frontmatter___screenshot___publicURL'
  | 'frontmatter___screenshot___childrenImageSharp'
  | 'frontmatter___screenshot___childrenImageSharp___gatsbyImageData'
  | 'frontmatter___screenshot___childrenImageSharp___id'
  | 'frontmatter___screenshot___childrenImageSharp___children'
  | 'frontmatter___screenshot___childImageSharp___gatsbyImageData'
  | 'frontmatter___screenshot___childImageSharp___id'
  | 'frontmatter___screenshot___childImageSharp___children'
  | 'frontmatter___screenshot___childrenMdx'
  | 'frontmatter___screenshot___childrenMdx___rawBody'
  | 'frontmatter___screenshot___childrenMdx___fileAbsolutePath'
  | 'frontmatter___screenshot___childrenMdx___slug'
  | 'frontmatter___screenshot___childrenMdx___body'
  | 'frontmatter___screenshot___childrenMdx___excerpt'
  | 'frontmatter___screenshot___childrenMdx___headings'
  | 'frontmatter___screenshot___childrenMdx___html'
  | 'frontmatter___screenshot___childrenMdx___mdxAST'
  | 'frontmatter___screenshot___childrenMdx___tableOfContents'
  | 'frontmatter___screenshot___childrenMdx___timeToRead'
  | 'frontmatter___screenshot___childrenMdx___id'
  | 'frontmatter___screenshot___childrenMdx___children'
  | 'frontmatter___screenshot___childMdx___rawBody'
  | 'frontmatter___screenshot___childMdx___fileAbsolutePath'
  | 'frontmatter___screenshot___childMdx___slug'
  | 'frontmatter___screenshot___childMdx___body'
  | 'frontmatter___screenshot___childMdx___excerpt'
  | 'frontmatter___screenshot___childMdx___headings'
  | 'frontmatter___screenshot___childMdx___html'
  | 'frontmatter___screenshot___childMdx___mdxAST'
  | 'frontmatter___screenshot___childMdx___tableOfContents'
  | 'frontmatter___screenshot___childMdx___timeToRead'
  | 'frontmatter___screenshot___childMdx___id'
  | 'frontmatter___screenshot___childMdx___children'
  | 'frontmatter___screenshot___id'
  | 'frontmatter___screenshot___parent___id'
  | 'frontmatter___screenshot___parent___children'
  | 'frontmatter___screenshot___children'
  | 'frontmatter___screenshot___children___id'
  | 'frontmatter___screenshot___children___children'
  | 'frontmatter___screenshot___internal___content'
  | 'frontmatter___screenshot___internal___contentDigest'
  | 'frontmatter___screenshot___internal___description'
  | 'frontmatter___screenshot___internal___fieldOwners'
  | 'frontmatter___screenshot___internal___ignoreType'
  | 'frontmatter___screenshot___internal___mediaType'
  | 'frontmatter___screenshot___internal___owner'
  | 'frontmatter___screenshot___internal___type'
...
export type HomeQuery = { hero?: Maybe<{ childMdx?: Maybe<{ frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'subtitle'>> }> }>, about?: Maybe<{ childMdx?: Maybe<(
      Pick<Mdx, 'body' | 'mdxAST'>
      & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title'>> }
    )> }>, tech?: Maybe<{ childMdx?: Maybe<{ frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'links'>> }> }>, myWork?: Maybe<{ childMdx?: Maybe<{ frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'order'>> }> }>, projects: { nodes: Array<(
      Pick<File, 'id'>
      & { childMdx?: Maybe<(
        Pick<Mdx, 'body'>
        & { frontmatter?: Maybe<(
